	;Completed for a lab assignment in COSC 2329, Comp Org & Machine Lang
	;Takes in 2 ASCII numbers, converts to their numeric form, and adds them together.
	;Then converts back to ASCII and prints to console.
		org 100h
